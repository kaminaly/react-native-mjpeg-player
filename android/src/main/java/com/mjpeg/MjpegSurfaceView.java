...
public class MjpegSurfaceView extends SurfaceView implements SurfaceHolder.Callback, MjpegView {
    ...
    public void setSource(MjpegInputStream stream, int frameWidth, int frameHeight) {
        mMjpegView.setSource(stream, frameWidth, frameHeight);
    }
    ...
    public String getDate() {
        if(mMjpegView != null && mMjpegView.getDate() != null){
            return mMjpegView.getDate();
        }
        return "";
    }
    ...
    public String getTime() {
        if(mMjpegView != null && mMjpegView.getTime() != null){
            return mMjpegView.getTime();
        }
       return "";
    }
